...
const Contact = () => {
  ...
  return (
    <div
      className={`xl:mt-1 flex xl:flex-row flex-col-reverse gap-5 overflow`}
    >
      <motion.div
        variants={slideIn('left', 'tween', 0.2, 1)}
        className="flex-[0.75] bg-white-100 p-12 rounded-2xl"
      >
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-black py-4 px-7 placeholder:text-white text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
      ...
      <motion.div
        ...
        className="xl:flex-1 xl:h-75 md:h-[550px] h-[350px]"
      >
        <EarthCanvas />
      </motion.div>
    </div>
